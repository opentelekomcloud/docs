# Creating a ClusterRoleBinding<a name="cce_02_0294"></a>

## Function<a name="section8881601595"></a>
...
## Request<a name="section662381310137"></a>

**Request parameters:**

[Table 2](#d0e42951)  describes the request parameters.
...
<td class="cellrowborder" valign="top" width="20.202020202020204%" headers="mcps1.2.5.1.3 "><p id="p157721753151112"><a name="p157721753151112"></a><a name="p157721753151112"></a><a href="#en-us_topic_0079615000_table58989182">roleref</a> object</p>
</td>
...
<div class="notice" id="note1070920993914"><a name="note1070920993914"></a><a name="note1070920993914"></a><span class="noticetitle"> NOTICE: </span><div class="noticebody"><p id="p1770912911394"><a name="p1770912911394"></a><a name="p1770912911394"></a>If a ClusterRoleBinding created by calling the API or running kubectl commands needs to be displayed on the console, the following key-value pairs must be added to the <strong id="b18156171412192"><a name="b18156171412192"></a><a name="b18156171412192"></a>annotations</strong> field. Otherwise, the ClusterRoleBinding may affect the operations of other ClusterRoleBindings on the console.</p>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p id="p72861289222"><a name="p72861289222"></a><a name="p72861289222"></a>Object (data structure of the <a href="data-structure-of-request-parameters.md#t693768b66dfa47239c0f155ad4dd18e8">initializers</a> field)</p>
</td>
...
**Table  4**  Data structure of the roleref field
...
<tbody><tr id="en-us_topic_0079615000_row59285030"><td class="cellrowborder" valign="top" width="21.8%" headers="mcps1.2.5.1.1 "><p id="en-us_topic_0079615000_p37358106"><a name="en-us_topic_0079615000_p37358106"></a><a name="en-us_topic_0079615000_p37358106"></a>apiGroup</p>
</td>
...
<td class="cellrowborder" valign="top" width="19.74%" headers="mcps1.2.5.1.3 "><p id="en-us_topic_0079615000_p24964816"><a name="en-us_topic_0079615000_p24964816"></a><a name="en-us_topic_0079615000_p24964816"></a>String</p>
</td>
...
**Table  5**  Data structure of the subjects field

<a name="table0504127112315"></a>
<table><thead align="left"><tr id="row6513112742318"><th class="cellrowborder" valign="top" width="21.8%" id="mcps1.2.5.1.1"><p id="p195151827102314"><a name="p195151827102314"></a><a name="p195151827102314"></a>Parameter</p>
</th>
<th class="cellrowborder" valign="top" width="19.17%" id="mcps1.2.5.1.2"><p id="p195181827182318"><a name="p195181827182318"></a><a name="p195181827182318"></a>Mandatory</p>
</th>
<th class="cellrowborder" valign="top" width="19.74%" id="mcps1.2.5.1.3"><p id="p25211827172312"><a name="p25211827172312"></a><a name="p25211827172312"></a>Type</p>
</th>
<th class="cellrowborder" valign="top" width="39.290000000000006%" id="mcps1.2.5.1.4"><p id="p5523427192315"><a name="p5523427192315"></a><a name="p5523427192315"></a>Description</p>
</th>
</tr>
</thead>
...
```
# The following ClusterRoleBinding object allows users in the manager user group to read secrets in any namespace of the cluster.
{
...
[Table 6](#d0e43055)  describes the status codes of this API.
