# Creating a Role<a name="cce_02_0302"></a>

## Function<a name="section15855440101611"></a>
...
<td class="cellrowborder" valign="top" width="60.61%" headers="mcps1.2.4.1.3 "><p id="p46408710414"><a name="p46408710414"></a><a name="p46408710414"></a>See <a href="#d0e42951">Table 2</a>.</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="20.202020202020204%" headers="mcps1.2.5.1.3 "><p id="p157721753151112"><a name="p157721753151112"></a><a name="p157721753151112"></a>Array of <a href="#table19605151152614">PolicyRule</a> objects</p>
</td>
...
<p id="p107851058122512"><a name="p107851058122512"></a><a name="p107851058122512"></a>Populated by the system. Read-only.</p>
</td>
</tr>
...
**Table  4**  Data structure of the PolicyRule field

<a name="table19605151152614"></a>
<table><thead align="left"><tr id="row5614195112262"><th class="cellrowborder" valign="top" width="22%" id="mcps1.2.5.1.1"><p id="p3616195118261"><a name="p3616195118261"></a><a name="p3616195118261"></a>Parameter</p>
</th>
<th class="cellrowborder" valign="top" width="19%" id="mcps1.2.5.1.2"><p id="p161855116261"><a name="p161855116261"></a><a name="p161855116261"></a>Mandatory</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.3"><p id="p15622115142616"><a name="p15622115142616"></a><a name="p15622115142616"></a>Type</p>
</th>
<th class="cellrowborder" valign="top" width="39%" id="mcps1.2.5.1.4"><p id="p146247514263"><a name="p146247514263"></a><a name="p146247514263"></a>Description</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p id="p1132714317276"><a name="p1132714317276"></a><a name="p1132714317276"></a>Array of strings</p>
</td>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p id="p208384513272"><a name="p208384513272"></a><a name="p208384513272"></a>Array of strings</p>
</td>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p id="p14719745192710"><a name="p14719745192710"></a><a name="p14719745192710"></a>Array of strings</p>
</td>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p id="p13061746142710"><a name="p13061746142710"></a><a name="p13061746142710"></a>Array of strings</p>
</td>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p id="p15426134954716"><a name="p15426134954716"></a><a name="p15426134954716"></a>Array of strings</p>
</td>
...
```
{
   ...
   "rules":[{
       "apiGroups": [""], #An empty character string "" indicates that the core API group is used.
       "resources": ["pods"],
...
[Table 5](#d0e43055)  describes the status codes of this API.
...
<tr id="row18201146173818"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p886495133310"><a name="p886495133310"></a><a name="p886495133310"></a>200</p>
</td>
...
<tr id="row629218495380"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="p13311555103311"><a name="p13311555103311"></a><a name="p13311555103311"></a>202</p>
</td>
