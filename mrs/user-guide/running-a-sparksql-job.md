# Running a SparkSql Job<a name="EN-US_TOPIC_0221415048"></a>
...
6.  If the cluster version is earlier than MRS 1.9.2, perform the following operations to create Spark Script and Spark SQL jobs:
