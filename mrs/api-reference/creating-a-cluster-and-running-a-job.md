...
<td class="cellrowborder" valign="top" width="15%" headers="mcps1.2.5.1.3 "><p id="ace2cc4b377a641aa8747c2a68e6d4591"><a name="ace2cc4b377a641aa8747c2a68e6d4591"></a><a name="ace2cc4b377a641aa8747c2a68e6d4591"></a>String</p>
</td>
...
<tr id="row193981314317"><td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.1 "><p id="p19731222132216"><a name="p19731222132216"></a><a name="p19731222132216"></a>root_volume_type</p>
</td>
...
<td class="cellrowborder" valign="top" width="15%" headers="mcps1.2.5.1.3 "><p id="af34227ad20af433b9482735d9009553a"><a name="af34227ad20af433b9482735d9009553a"></a><a name="af34227ad20af433b9482735d9009553a"></a>Integer</p>
</td>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.3 "><p id="en-us_topic_0110581924_p653869210328"><a name="en-us_topic_0110581924_p653869210328"></a><a name="en-us_topic_0110581924_p653869210328"></a>Integer</p>
</td>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.3 "><p id="aa5272848817f4c65a9af69ac02779280"><a name="aa5272848817f4c65a9af69ac02779280"></a><a name="aa5272848817f4c65a9af69ac02779280"></a>String</p>
</td>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="aa490089a63c94300b70d99031675ceae"><a name="aa490089a63c94300b70d99031675ceae"></a><a name="aa490089a63c94300b70d99031675ceae"></a>This parameter is a multi-disk parameter, indicating the number of data disks of the Master node.</p>
...
<td class="cellrowborder" valign="top" width="44.9%" headers="mcps1.2.5.1.4 "><p id="a843f55e3857048b3822853a8d5c86cf6"><a name="a843f55e3857048b3822853a8d5c86cf6"></a><a name="a843f55e3857048b3822853a8d5c86cf6"></a>Auto scaling policy. For details, see <a href="#t6d6054a35d6342dc9dc5b3b8580fec7c">Table 9</a>.</p>
</td>
</tr>
</tbody>
</table>

**Table  7** **component\_list**  parameter description
...
**Table  8** **add\_jobs**  parameter description
...
<a name="ue3629268b08343339d7421380a9d1653"></a><a name="ue3629268b08343339d7421380a9d1653"></a><ul id="ue3629268b08343339d7421380a9d1653"><li>Contains a maximum of 1,023 characters, excluding special characters such as ;|&amp;&gt;&lt;'$. The parameter value cannot be empty or full of spaces.</li><li>Files can be stored in HDFS or OBS. The path varies depending on the file system.<a name="en-us_topic_0110581924_ul56833471484"></a><a name="en-us_topic_0110581924_ul56833471484"></a><ul id="en-us_topic_0110581924_ul56833471484"><li>OBS: The path must start with <span class="parmvalue" id="parmvalue47194518336"><a name="parmvalue47194518336"></a><a name="parmvalue47194518336"></a><b>s3a://</b></span>. Files or programs encrypted by KMS are not supported.</li><li>HDFS: The path starts with a slash (<span class="parmvalue" id="pee15970daa044de1af6e19920c2672f4"><a name="pee15970daa044de1af6e19920c2672f4"></a><a name="pee15970daa044de1af6e19920c2672f4"></a><b>/</b></span>).</li></ul>
</li><li>Spark Script must end with <span class="parmvalue" id="p3f1c52d30e994432aa417b0b16e8191c"><a name="p3f1c52d30e994432aa417b0b16e8191c"></a><a name="p3f1c52d30e994432aa417b0b16e8191c"></a><b>.sql</b></span> while MapReduce and Spark Jar must end with <span class="parmvalue" id="pd88ebb6bea614a6098ff4c46567c4c0f"><a name="pd88ebb6bea614a6098ff4c46567c4c0f"></a><a name="pd88ebb6bea614a6098ff4c46567c4c0f"></a><b>.jar</b></span>. <span class="parmvalue" id="parmvalue10319175814292"><a name="parmvalue10319175814292"></a><a name="parmvalue10319175814292"></a><b>sql</b></span> and <span class="parmvalue" id="parmvalue1128641253013"><a name="parmvalue1128641253013"></a><a name="parmvalue1128641253013"></a><b>jar</b></span> are case-insensitive.</li></ul>
</td>
</tr>
...
<div class="p" id="p102911911431"><a name="p102911911431"></a><a name="p102911911431"></a>Files can be stored in HDFS or OBS. The path varies depending on the file system.<a name="ul7291411238"></a><a name="ul7291411238"></a><ul id="ul7291411238"><li>OBS: The path must start with <span class="parmvalue" id="parmvalue132913115310"><a name="parmvalue132913115310"></a><a name="parmvalue132913115310"></a><b>s3a://</b></span>. Files or programs encrypted by KMS are not supported.</li><li>HDFS: The path starts with a slash (<span class="parmvalue" id="parmvalue6291611839"><a name="parmvalue6291611839"></a><a name="parmvalue6291611839"></a><b>/</b></span>).</li></ul>
</div>
...
<div class="p" id="p279517257319"><a name="p279517257319"></a><a name="p279517257319"></a>Files can be stored in HDFS or OBS. The path varies depending on the file system.<a name="ul37951325238"></a><a name="ul37951325238"></a><ul id="ul37951325238"><li>OBS: The path must start with <span class="parmvalue" id="parmvalue197951251037"><a name="parmvalue197951251037"></a><a name="parmvalue197951251037"></a><b>s3a://</b></span>. Files or programs encrypted by KMS are not supported.</li><li>HDFS: The path starts with a slash (<span class="parmvalue" id="parmvalue1405037155"><a name="parmvalue1405037155"></a><a name="parmvalue1405037155"></a><b>/</b></span>).</li></ul>
</div>
...
<a name="u283ed191b20545218c2495ce20019235"></a><a name="u283ed191b20545218c2495ce20019235"></a><ul id="u283ed191b20545218c2495ce20019235"><li><strong id="b2497195641514"><a name="b2497195641514"></a><a name="b2497195641514"></a>true</strong>: Yes</li><li><strong id="b1541915011164"><a name="b1541915011164"></a><a name="b1541915011164"></a>false</strong>: No</li></ul>
</td>
</tr>
...
<a name="ubd8933d2af864220afae2e8a2fe1f8db"></a><a name="ubd8933d2af864220afae2e8a2fe1f8db"></a><ul id="ubd8933d2af864220afae2e8a2fe1f8db"><li><strong id="b153568129611"><a name="b153568129611"></a><a name="b153568129611"></a>import</strong></li><li><strong id="b1016418241467"><a name="b1016418241467"></a><a name="b1016418241467"></a>export</strong></li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="45%" headers="mcps1.2.5.1.4 "><a name="u252aadfb54da4baaa43f5c40ec014fc0"></a><a name="u252aadfb54da4baaa43f5c40ec014fc0"></a><ul id="u252aadfb54da4baaa43f5c40ec014fc0"><li><strong id="b1762449101619"><a name="b1762449101619"></a><a name="b1762449101619"></a>true</strong>: Submit a job during cluster creation.</li><li><strong id="b15176313161614"><a name="b15176313161614"></a><a name="b15176313161614"></a>false</strong>: Submit a job after the cluster is created.</li></ul>
...
<a name="u9852e5488841460c9a61db547eec1126"></a><a name="u9852e5488841460c9a61db547eec1126"></a><ul id="u9852e5488841460c9a61db547eec1126"><li>Contains a maximum of 1,023 characters, excluding special characters such as ;|&amp;&gt;&lt;'$. The parameter value cannot be empty or full of spaces.</li><li>Files can be stored in HDFS or OBS. The path varies depending on the file system.<a name="ul6960439732"></a><a name="ul6960439732"></a><ul id="ul6960439732"><li>OBS: The path must start with <span class="parmvalue" id="parmvalue49601139333"><a name="parmvalue49601139333"></a><a name="parmvalue49601139333"></a><b>s3a://</b></span>. Files or programs encrypted by KMS are not supported.</li><li>HDFS: The path starts with a slash (<span class="parmvalue" id="parmvalue08242411474"><a name="parmvalue08242411474"></a><a name="parmvalue08242411474"></a><b>/</b></span>).</li></ul>
</li><li>Ends with <span class="parmvalue" id="ped754121c03f48188a0dc13d9fe665ae"><a name="ped754121c03f48188a0dc13d9fe665ae"></a><a name="ped754121c03f48188a0dc13d9fe665ae"></a><b>.sql</b></span>. <strong id="b131626419487"><a name="b131626419487"></a><a name="b131626419487"></a>sql</strong> is case-insensitive.</li></ul>
</td>
</tr>
</tbody>
</table>

**Table  9** **auto\_scaling\_policy**  parameter description
...
<td class="cellrowborder" valign="top" width="45%" headers="mcps1.2.5.1.4 "><p id="p189881644171514"><a name="p189881644171514"></a><a name="p189881644171514"></a>Resource plan list. For details, see <a href="#table10281451162111">Table 10</a>. If this parameter is left blank, the resource plan is disabled.</p>
...
<td class="cellrowborder" valign="top" width="45%" headers="mcps1.2.5.1.4 "><p id="p93729233178"><a name="p93729233178"></a><a name="p93729233178"></a>List of custom scaling automation scripts. For details, see <a href="#table1921110172216">Table 11</a>. If this parameter is left blank, a hook script is disabled.</p>
...
<td class="cellrowborder" valign="top" width="45%" headers="mcps1.2.5.1.4 "><p id="ac2e02b36ba1e434fb0df7479bd8acd50"><a name="ac2e02b36ba1e434fb0df7479bd8acd50"></a><a name="ac2e02b36ba1e434fb0df7479bd8acd50"></a>List of auto scaling rules. For details, see <a href="#t4c9e3e169631470d81d260543affb7e1">Table 12</a>.</p>
...
**Table  10** **resources\_plan**  parameter description
...
<a name="ul363284116288"></a><a name="ul363284116288"></a><ul id="ul363284116288"><li><strong id="b1429315401761"><a name="b1429315401761"></a><a name="b1429315401761"></a>daily</strong></li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="45%" headers="mcps1.2.5.1.4 "><p id="p2633174117282"><a name="p2633174117282"></a><a name="p2633174117282"></a>End time of a resource plan. The value is in the same format as that of <span class="parmname" id="parmname108341828162917"><a name="parmname108341828162917"></a><a name="parmname108341828162917"></a><b>start_time</b></span>. The interval between <strong id="b1917973215256"><a name="b1917973215256"></a><a name="b1917973215256"></a>end_time</strong> and <strong id="b149161137152511"><a name="b149161137152511"></a><a name="b149161137152511"></a>start_time</strong> must be greater than or equal to 30 minutes.</p>
</td>
</tr>
...
**Table  11** **exec\_script**  parameter description
...
<a name="ul2716122616303"></a><a name="ul2716122616303"></a><ul id="ul2716122616303"><li>OBS bucket path: Enter a script path manually, for example, <strong id="b0322910101"><a name="b0322910101"></a><a name="b0322910101"></a>s3a://</strong><em id="i449293102"><a name="i449293102"></a><a name="i449293102"></a>XXX</em><strong id="b1645290107"><a name="b1645290107"></a><a name="b1645290107"></a>/scale.sh</strong>.</li><li>Local VM path: Enter a script path. The script path must start with a slash (/) and end with <strong id="b2635103117309"><a name="b2635103117309"></a><a name="b2635103117309"></a>.sh</strong>.</li></ul>
</td>
</tr>
...
<a name="ul19405172713813"></a><a name="ul19405172713813"></a><ul id="ul19405172713813"><li>Multiple parameters are separated by space.</li><li>The following predefined system parameters can be transferred:<a name="ul740512275389"></a><a name="ul740512275389"></a><ul id="ul740512275389"><li><em id="i1775514120161"><a name="i1775514120161"></a><a name="i1775514120161"></a>${mrs_scale_node_num}</em>: Number of the nodes to be added or removed</li><li><em id="i11570546161617"><a name="i11570546161617"></a><a name="i11570546161617"></a>${mrs_scale_type}</em>: Scaling type. The value can be <strong id="b209806114324"><a name="b209806114324"></a><a name="b209806114324"></a>scale_out</strong> or <strong id="b16355132010329"><a name="b16355132010329"></a><a name="b16355132010329"></a>scale_in</strong>.</li><li><em id="i185932506163"><a name="i185932506163"></a><a name="i185932506163"></a>${mrs_scale_node_hostnames}</em>: Host names of the nodes to be added or removed</li><li><em id="i1173835416165"><a name="i1173835416165"></a><a name="i1173835416165"></a>${mrs_scale_node_ips}</em>: IP addresses of the nodes to be added or removed</li><li><em id="i2343185981616"><a name="i2343185981616"></a><a name="i2343185981616"></a>${mrs_scale_rule_name}</em>: Name of the rule that triggers auto scaling</li></ul>
...
<a name="ul959511385379"></a><a name="ul959511385379"></a><ul id="ul959511385379"><li><strong id="b1797820530815"><a name="b1797820530815"></a><a name="b1797820530815"></a>before_scale_out</strong>: before scale-out</li><li><strong id="b695615717811"><a name="b695615717811"></a><a name="b695615717811"></a>before_scale_in</strong>: before scale-in</li><li><strong id="b53821541396"><a name="b53821541396"></a><a name="b53821541396"></a>after_scale_out</strong>: after scale-out</li><li><strong id="b10866167091"><a name="b10866167091"></a><a name="b10866167091"></a>after_scale_in</strong>: after scale-in</li></ul>
</td>
</tr>
...
<p id="a3913d07fc617486c800f3e34ebc28224"><a name="a3913d07fc617486c800f3e34ebc28224"></a><a name="a3913d07fc617486c800f3e34ebc28224"></a>It contains a maximum of 1,024 characters.</p>
</td>
</tr>
...
<a name="u18ec9abfa0234393b376df8ff616d19b"></a><a name="u18ec9abfa0234393b376df8ff616d19b"></a><ul id="u18ec9abfa0234393b376df8ff616d19b"><li><strong id="b183151315782"><a name="b183151315782"></a><a name="b183151315782"></a>scale_out</strong>: cluster scale-out</li><li><strong id="b658210174816"><a name="b658210174816"></a><a name="b658210174816"></a>scale_in</strong>: cluster scale-in</li></ul>
</td>
</tr>
...
<p id="a934200a982984f90a54b157715b28542"><a name="a934200a982984f90a54b157715b28542"></a><a name="a934200a982984f90a54b157715b28542"></a>Value range: 0 to 10,080. One week is equal to 10,080 minutes.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="45%" headers="mcps1.2.5.1.4 "><p id="a2c60fdaa8e8b434d91a9aaf1e369eff6"><a name="a2c60fdaa8e8b434d91a9aaf1e369eff6"></a><a name="a2c60fdaa8e8b434d91a9aaf1e369eff6"></a>Condition for triggering a rule. For details, see <a href="#t03bd10dc0ec94a3babc71b2d5d57c3fe">Table 13</a>.</p>
</td>
</tr>
</tbody>
</table>
...
<p id="a249e5e0f422a474eb818f01e56c3c6e2"><a name="a249e5e0f422a474eb818f01e56c3c6e2"></a><a name="a249e5e0f422a474eb818f01e56c3c6e2"></a><a href="#t27de3279a99a48968dacb015c498d9cb">Table 14</a> lists the supported metric names.</p>
</td>
</tr>
...
<p id="a9cb6280b4c514776b95dd786fe3b71b9"><a name="a9cb6280b4c514776b95dd786fe3b71b9"></a><a name="a9cb6280b4c514776b95dd786fe3b71b9"></a>The parameter value must be an integer or number with two decimal places only. <a href="#t27de3279a99a48968dacb015c498d9cb">Table 14</a> provides value types and ranges corresponding to <strong id="b1161104445418"><a name="b1161104445418"></a><a name="b1161104445418"></a>metric_name</strong>.</p>
</td>
</tr>
...
<a name="u7169b3049e9342e185a5074148528db2"></a><a name="u7169b3049e9342e185a5074148528db2"></a><ul id="u7169b3049e9342e185a5074148528db2"><li><strong id="b2621194719713"><a name="b2621194719713"></a><a name="b2621194719713"></a>LT</strong>: less than</li><li><strong id="b4198541711"><a name="b4198541711"></a><a name="b4198541711"></a>GT</strong>: greater than</li><li><strong id="b11432135816714"><a name="b11432135816714"></a><a name="b11432135816714"></a>LTOE</strong>: less than or equal to</li><li><strong id="b4952162287"><a name="b4952162287"></a><a name="b4952162287"></a>GTOE</strong>: greater than or equal to</li></ul>
</td>
</tr>
...
<p id="p1690164451113"><a name="p1690164451113"></a><a name="p1690164451113"></a>Value range: 0 to 6,000</p>
</td>
</tr>
...
>When the value type is percentage or ratio in  [Table 14](#t27de3279a99a48968dacb015c498d9cb), the valid value can be accurate to percentile. The percentage metric value is a decimal value with a percent sign \(%\) removed. For example, 16.80 represents 16.80%.

**Table  15** **bootstrap\_scripts**  parameter description
...
<td class="cellrowborder" valign="top" width="45%" headers="mcps1.2.5.1.4 "><p id="p12585928145012"><a name="p12585928145012"></a><a name="p12585928145012"></a>Type of a node where the bootstrap action script is executed. The value can be <strong id="b36558185717"><a name="b36558185717"></a><a name="b36558185717"></a>Master</strong>, <strong id="b195826211971"><a name="b195826211971"></a><a name="b195826211971"></a>Core</strong>, or <strong id="b15989241079"><a name="b15989241079"></a><a name="b15989241079"></a>Task</strong>.</p>
</td>
</tr>
...
<a name="ul18391113413191"></a><a name="ul18391113413191"></a><ul id="ul18391113413191"><li><strong id="b595449267"><a name="b595449267"></a><a name="b595449267"></a>continue</strong>: Continue to execute subsequent scripts.</li><li><strong id="b1279175113610"><a name="b1279175113610"></a><a name="b1279175113610"></a>errorout</strong>: Stop the action.</li></ul>
<div class="p" id="p1818026201614"><a name="p1818026201614"></a><a name="p1818026201614"></a>The default value is <strong id="b8898494106"><a name="b8898494106"></a><a name="b8898494106"></a>errorout</strong>, indicating that the action is stopped.<div class="note" id="note796819345579"><a name="note796819345579"></a><a name="note796819345579"></a><span class="notetitle"> NOTE: </span><div class="notebody"><p id="p6994625143710"><a name="p6994625143710"></a><a name="p6994625143710"></a>You are advised to set this parameter to <strong id="b1662648361"><a name="b1662648361"></a><a name="b1662648361"></a>continue</strong> in the commissioning phase so that the cluster can continue to be installed and started no matter whether the bootstrap action is successful.</p>
</div></div>
</div>
</td>
</tr>
...
<a name="uc323531d101446e59160932bb68f00ba"></a><a name="uc323531d101446e59160932bb68f00ba"></a><ul id="uc323531d101446e59160932bb68f00ba"><li><strong id="b13529105510304"><a name="b13529105510304"></a><a name="b13529105510304"></a>true</strong>: The operation is successful.</li><li><strong id="b2062485833012"><a name="b2062485833012"></a><a name="b2062485833012"></a>false</strong>: The operation failed.</li></ul>
</td>
</tr>
...
-   Example request
    -   Creating a cluster with  **Cluster HA**  enabled \(using the  **node\_groups**  parameter group\)
    ...
    -   Creating a cluster with  **Cluster HA**  enabled \(without using the  **node\_groups**  parameter group\)
    ...
    -   Disabling the  **Cluster HA**  function and creating a cluster with the minimum specifications \(using the  **node\_groups**  parameter group\)
    ...
    -   Disabling the  **Cluster HA**  function and creating a cluster with the minimum specifications \(without using the  **node\_groups**  parameter group\)
...
[Table 17](#t9da59f1e3aaa4a09903f34b2fc2401e4)  describes the status code of this API.
