...
-   Parameter description
    ...
    **Table  1** **server\_group**  field description
    ...
    <p id="p490217144311"><a name="p490217144311"></a><a name="p490217144311"></a>You can obtain this value by calling the API described in <a href="active-active-domain.md">Active-Active Domain</a>.</p>
    </td>
    </tr>
    ...
    <p id="p34672113453"><a name="p34672113453"></a><a name="p34672113453"></a>You can obtain this value by calling the API described in <a href="active-active-domain.md">Active-Active Domain</a>.</p>
    </td>
    </tr>
    ...
    <p id="p42271928194513"><a name="p42271928194513"></a><a name="p42271928194513"></a>You can obtain this value by calling the API described in <a href="active-active-domain.md">Active-Active Domain</a>.</p>
    </td>
    </tr>
