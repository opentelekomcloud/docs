# Deleting One Piece of Metadata for an EVS Snapshot<a name="evs_04_2104"></a>
...
-   Parameter description
    ...
    <tbody><tr id="row135502511261"><td class="cellrowborder" valign="top" width="20.24%" headers="mcps1.1.4.1.1 "><p id="p129522216412"><a name="p129522216412"></a><a name="p129522216412"></a>error</p>
    </td>
