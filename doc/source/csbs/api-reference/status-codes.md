# Status Codes<a name="EN-US_TOPIC_0134484533"></a>

-   Normal

    <a name="table5683702611201"></a>
    <table><thead align="left"><tr id="row5526436211201"><th class="cellrowborder" valign="top" width="43%" id="mcps1.1.3.1.1"><p id="p4722834111201"><a name="p4722834111201"></a><a name="p4722834111201"></a><strong id="b1512118471243"><a name="b1512118471243"></a><a name="b1512118471243"></a>Status Code</strong></p>
    </th>
    <th class="cellrowborder" valign="top" width="56.99999999999999%" id="mcps1.1.3.1.2"><p id="p29038811201"><a name="p29038811201"></a><a name="p29038811201"></a><strong id="b153641936114010"><a name="b153641936114010"></a><a name="b153641936114010"></a>Description</strong></p>
    </th>
    </tr>
    </thead>
...
-   Abnormal
    ...
    <table><thead align="left"><tr id="row6491025211201"><th class="cellrowborder" valign="top" width="43.419999999999995%" id="mcps1.1.3.1.1"><p id="p2323902311201"><a name="p2323902311201"></a><a name="p2323902311201"></a><strong id="b18996747547"><a name="b18996747547"></a><a name="b18996747547"></a>Status Code</strong></p>
    </th>
    <th class="cellrowborder" valign="top" width="56.58%" id="mcps1.1.3.1.2"><p id="p331274811201"><a name="p331274811201"></a><a name="p331274811201"></a><strong id="b1125944164112"><a name="b1125944164112"></a><a name="b1125944164112"></a>Description</strong></p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="56.58%" headers="mcps1.1.3.1.2 "><p id="p339302111201"><a name="p339302111201"></a><a name="p339302111201"></a>The request is not completed because the service is abnormal.</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="56.58%" headers="mcps1.1.3.1.2 "><p id="p3454733011201"><a name="p3454733011201"></a><a name="p3454733011201"></a>The request is not completed because the server does not support the requested function.</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="56.58%" headers="mcps1.1.3.1.2 "><p id="p1008477711201"><a name="p1008477711201"></a><a name="p1008477711201"></a>The request is not completed because the request is invalid.</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="56.58%" headers="mcps1.1.3.1.2 "><p id="p3907275011201"><a name="p3907275011201"></a><a name="p3907275011201"></a>The request is not completed because the system is out of service temporarily.</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="56.58%" headers="mcps1.1.3.1.2 "><p id="p408623011201"><a name="p408623011201"></a><a name="p408623011201"></a>Gateway times out.</p>
    </td>
    </tr>
    </tbody>
    </table>
